    ...
    <div className="mt-20">
      <div className="text-center">
        ...
        <a
          ...
          className="text-neutral-800 dark:text-white font-bold text-3xl cursor-pointer"
        >
          Jay Nico
        </a>
      ...
      <div className="text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] pt-12 py-6">
        ...
        <ul className="flex items-center gap-10 justify-center mt-4 sm:mt-0">
          <li>
            <a target="_blank" href="https://github.com/jaynico-dev/">
              Github
            </a>
          </li>
          <li>
            <a target="_blank" href="https://www.linkedin.com/in/jaynicoolano/">
              LinkedIn
            </a>
          </li>
        </ul>
